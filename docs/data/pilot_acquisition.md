...
size, and cost. It reuses one metadata client, runs sequentially, records safe
operation timings, retries only bounded transient failures, and enforces a
...
request manifest after a successful preflight.

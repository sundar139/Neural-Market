...
ExecutionState = Literal[
    ...
    "quality_validated",
    "uncertain_billing",
    "billed_without_validated_artifact",
...
ALLOWED_TRANSITIONS: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        ("uncertain_billing", "billed_without_validated_artifact"),
        ("uncertain_billing", "retry_eligible_after_manual_nonbilling_confirmation"),
